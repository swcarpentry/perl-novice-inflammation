...
so this introduction to Perl is built around a common scientific task:
data analysis.

Our real goal isn't to teach you Perl,
but to teach you the basic concepts that all programming depends on.
We use Perl in our lessons because:
...
1.  [Analyzing Patient Data](01-pdl.html)
